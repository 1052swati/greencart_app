    ...
    return (
        ...
        >
            ...
            <form
                onSubmit={onSubmitHandler}
                onClick={(e) => e.stopPropagation()}
                className="flex flex-col gap-4 items-start p-8 py-10 w-[90%] max-w-[350px] text-gray-500 rounded-lg shadow-xl border border-gray-200 bg-white"
            >
                ...
                <button
                    disabled={loading}
                    className="bg-[var(--color-primary)] hover:bg-primary-dull transition-all text-white w-full py-2 rounded-md cursor-pointer"
                >
                    {loading 
                        ? "Please wait..." 
                        : state === "register" 
